...
<h5>Number of detected inconsistency between main and water_count_loop:<strong> `r if(exists('loop_counts_main_3')){nrow(loop_counts_main_3)}else {0}` </strong></h5>
...
if(all(fcs_check_columns %in% names(raw.flag.fcs))) {
  ...
  (plot_ridge_distribution_phu(raw.flag.fcs, numeric_cols = c("fsl_fcs_cereal", "fsl_fcs_dairy", "fsl_fcs_veg", "fsl_fcs_fruit", "fsl_fcs_legumes", "fsl_fcs_sugar", "fsl_fcs_oil","fsl_fcs_meat"),
