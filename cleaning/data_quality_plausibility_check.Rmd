...
### ADD INFORMATION HERE ABOUT THE REPORT 
...
bind <- data.frame(`Indicator Score` = c("plaus_fcs","plaus_fcs","plaus_fcs","plaus_fcs","plaus_fcs","plaus_fcs",
                                         ...
                                         "plaus_rcsi","plaus_rcsi","plaus_rcsi","plaus_rcsi","plaus_rcsi",
                                         "plaus_hhs","plaus_hhs","plaus_hhs","plaus_hhs",
...
overall_fsl_plaus <- overall_fsl_plaus%>% 
  ...
  mutate(indscore = paste0(indscore,"/20")) %>% 
  select(-Indicator.Score)
fsl <- flextable(overall_fsl_plaus)
...
#### Cumultive Distribution MUAC without Flag
...
#### Cumultive Distribution MUAC with Flag per Enumerator
...
results_mort <- create_mortality_quality_report_test(raw.mort.flags$crude,
                                                     raw.mort.flags$ratios)

results_mort_enum <- create_mortality_quality_report_test(raw.mort.flags$crude,
                                                     raw.mort.flags$ratios,
                                                     grouping = "enumerator")
```
